...
Public Class frmSuppliers
    ...
    Function populateSupplier() As Boolean
        ...
        sql = "select SupplierID, SupplierName, Address, ContactPerson, " _
            ...
            & "from tblSupplier as a inner join tblEmpUsers as b on a.Added_by=b.EmpID where a.Deleted_at is null order by SupplierID desc"
    ...
    Function Search() As Boolean
        Try
            ...
            & "from tblSupplier where a.Deleted_at is null And SupplierName Like '%" & txtsearch.Text & "%' order by SupplierID desc"
                Call populate(sql, dgsupplier)
